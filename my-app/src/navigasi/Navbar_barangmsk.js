...
function Navbar_barangmsk() {
  ...
  const barang = async()=>{
    ...
    setdata(hasil.filter((item)=> item.keterangan === 'Barang masuk'));
  }
  ...
  <div className="d-flex flex-row">
    ...
    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value={serch} onChange={(e)=>setserch(e.target.value)}/>
      ...
      <li className='nav-item dropdown'>
        ...
        <li className="nav-item" style={{ zIndex: '0' }}>
          <a href="/Barang_masuk" className="nav-link text-white active">
    ...
    <div className="flex-grow-1">
      <Riwayat items={data} judul={"BARANG MASUK"} style={{width:"100%"}}/>
    </div>
  </div>
...
export default Navbar_barangmsk;
