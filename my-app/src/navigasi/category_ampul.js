...
function Category_ampul() {
  ...
  const barang = async()=>{
    ...
    setdata(reverse.filter((item)=> item.TIPE_barang === 'AMPUL'));
  }
  ...
  <div className="d-flex flex-row">
        ...
        <li className='nav-item dropdown'>
          ...
          {list ? (
            <ul className="nav nav-pills flex-column mb-auto">
              ...
              <li className="nav-item">
                <a href="http://localhost:3000/type_ampul" className="nav-link text-white active" aria-current="page">
    ...
    <Beranda items={data} judul={"TYPE AMPUL"} style={{width:"100%"}}/> 
    </div>
  </div>
