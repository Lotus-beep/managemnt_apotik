...
function Navbar_barangkeluar() {
  ...
  const barang = async()=>{
    ...
    setdata(hasil.filter((item)=> item.keterangan === 'Barang keluar'));
  }
  ...
  const percarian = async(e)=>{
    ...
    setdata(reverse.filter((item)=> item.keterangan === 'Barang keluar'));
  }
  ...
  <div className="d-flex flex-row">
      ...
      <li className='nav-item dropdown'>
        ...
        <li className="nav-item">
          <a href="http://localhost:3000/" className="nav-link text-white" aria-current="page">
            <i className="fa fa-home"><IoIosHome /></i><span className="ms-2">Home</span>
          </a>
        </li>
        <li className='nav-item dropdown'>
        ...
        <li className="nav-item">
          <a href="/Barang_keluar" className="nav-link text-white active">
    ...
    <div className="flex-grow-1">
      <Riwayat items={data} judul={"BARANG KELUAR"} style={{width:"100%"}}/>
    </div>
  </div>
...
export default Navbar_barangkeluar;
