...
function Alatbox() {
  ...
  const barang = async()=>{
    ...
    setdata(reverse.filter((item)=> item.TIPE_barang === 'BOX'));
  }
  ...
  <div className="d-flex flex-row">
      ...
      <li className='nav-item dropdown'>
          ...
          {alat ? (
            <ul className="nav nav-pills flex-column mb-auto">
              ...
              <li className="nav-item">
                <a href="http://localhost:3000/Alat_box" className="nav-link text-white active" aria-current="page">
    ...
    <Beranda items={data} judul={"ALAT TYPE BOX"} style={{width:"100%"}}/> 
    </div>
  </div>
