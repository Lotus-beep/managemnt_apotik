...
function Navbar_alat() {
  ...
  <div className="d-flex flex-row">
    ...
    <div class="input-group mb-3">
     ...
     <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value={serch} onChange={(e)=>setserch(e.target.value)}/>
      ...
      <li className="nav-item">
          <a href="http://localhost:3000/" className="nav-link text-white active" aria-current="page">
      ...
      <li className='nav-item dropdown'>
          <a href="#" className="nav-link dropdown-toggle text-white" id="navbarDropdown" role="button" data-bs-toggle="dropdown" onClick={toggleList}>
            <i className="fa fa-dashboard"><BiSolidCategory /></i><span className="ms-2">Categori Obat</span>
          </a>
          {list ? (
            <ul className="nav nav-pills flex-column mb-auto">
              <li className="nav-item">
    ...
    <div className="flex-grow-1">
      <Beranda items={data} judul={"DATA ALAT KESEHATAN"} style={{width:"100%"}}/>
    </div>
  </div>
