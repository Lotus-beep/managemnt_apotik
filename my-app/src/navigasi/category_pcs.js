...
function Category_pcs() {
  ...
  <div className="d-flex flex-row">
        ...
        <li className='nav-item dropdown'>
          ...
          {list ? (
            <ul className="nav nav-pills flex-column mb-auto">
              ...
              <li className="nav-item">
                <a href="http://localhost:3000/type_pcs" className="nav-link text-white active" aria-current="page">
                  <i className="fa fa-home"></i><span className="ms-2">Pcs</span>
                </a>
              </li>
              <li className="nav-item">
    ...
    <Beranda items={data} judul={"TYPE PCS"} style={{width:"100%"}}/> 
    </div>
  </div>
