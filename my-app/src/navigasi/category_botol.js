...
function Category_botol() {
  ...
  const barang = async()=>{
    ...
    setdata(reverse.filter((item)=> item.TIPE_barang === 'BOTOL'));
  }
  ...
  <div className="d-flex flex-row">
      ...
      <li className='nav-item dropdown'>
        ...
        <li className='nav-item dropdown'>
          ...
          {list ? (
            <ul className="nav nav-pills flex-column mb-auto">
              <li className="nav-item">
                <a href="http://localhost:3000/type_botol" className="nav-link text-white active" aria-current="page">
    ...
    <Beranda items={data} judul={"TYPE BOTOL"} style={{width:"100%"}}/> 
    </div>
  </div>
