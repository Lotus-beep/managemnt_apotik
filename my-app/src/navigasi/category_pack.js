...
function Category_pack() {
  ...
  const barang = async()=>{
    ...
    setdata(reverse.filter((item)=> item.TIPE_barang === 'PACK'));
  }
  ...
  <div className="d-flex flex-row">
        ...
        <li className='nav-item dropdown'>
          ...
          {list ? (
            <ul className="nav nav-pills flex-column mb-auto">
              ...
              <li className="nav-item">
                <a href="http://localhost:3000/type_pack" className="nav-link text-white active" aria-current="page">
    ...
    <Beranda items={data} judul={"TYPE PACK"} style={{width:"100%"}}/> 
    </div>
  </div>
